...
function Logo () {
    return (
        <div style={{width: "176px", }}>
            <a>   
                <svg role="img" aria-hidden="true" className="decathlon-logo " fill="#0082c3" viewBox="0 0 176 44"><title>Decathlon</title><path d="M140.8,22.1c0,3.3-2.7,5.9-5.9,5.9c-3.2,0-5.9-2.6-5.9-5.9c0-3.2,2.7-5.9,5.9-5.9
